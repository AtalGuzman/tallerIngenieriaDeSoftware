...
function($scope, $state, inspectionOrder_factory, $ionicHistory, $ionicModal, $ionicPopup, Camera) {
    ...
    function verificarErrores(){
      $scope.error_recepcionado_por = inspectionOrder_factory.verificar_conformidad_repecionadoPor($scope.conformity_data);
      $scope.error_data_telefono = inspectionOrder_factory.verificar_conformidad_telefono($scope.conformity_data);
