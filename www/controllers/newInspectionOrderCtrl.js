...
function($rootScope,$scope, $state, $ionicPopup, $ionicModal,
  ...
  $scope.save = function(data){
    $rootScope.ordenesDeInspeccion.push(data);
    console.log($rootScope.ordenesDeInspeccion);
    $state.go('home');
  }
